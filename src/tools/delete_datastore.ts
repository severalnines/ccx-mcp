...
export function register(server: McpServer) {
  server.tool(
    ...
    "Delete a CCX datastore. This is DESTRUCTIVE and cannot be undone. You must set confirm to true. Only available when protection mode is off (CCX_PROTECT=false).",
    {
      datastore_uuid: z
        .string()
